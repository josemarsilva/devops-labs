...
* [`Cenario_CI-Jenkins-Git-Build-Test_DEV-Java-Maven.md`: Executa Job do Jenkins (Pipeline) que baixa projeto do GitHub, faz o build do projeto usando o Maven, com UnitTest e compila e gera o binário do aplicativo para distribuição](README_Cenario_CI-Jenkins-Git-Build-Test_DEV-Java-Maven.md.md)
